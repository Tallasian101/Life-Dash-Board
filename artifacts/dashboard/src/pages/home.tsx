  ...
  return (
    <div className="min-h-screen bg-[#050A15] text-slate-200 selection:bg-primary/30 selection:text-white pb-12">
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-[-20%] left-[-10%] w-[50%] h-[50%] bg-primary/5 blur-[120px] rounded-full mix-blend-screen transition-colors duration-700" />
      ...
      <div className="max-w-6xl mx-auto px-6 pt-12 relative z-10">
        <header className="flex items-end justify-between mb-10 pb-6 border-b border-white/10">
          <div className="flex items-center gap-3">
            <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-primary/20 to-primary/5 border border-primary/20 flex items-center justify-center transition-colors duration-700">
        ...
        <main className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="h-[400px] animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300 fill-mode-both">
            <NewsWidget />
          </div>

          <div className="h-[400px] animate-in fade-in slide-in-from-bottom-4 duration-700 delay-400 fill-mode-both">
            <QuoteWidget />
          </div>
